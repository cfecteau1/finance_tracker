class UserStocksController < ApplicationController
  ...
  def create
    if params[:stock_id].present? #if stock_id present do...
    ...
    respond_to do |format|
      if @user_stock.save
        ...
        notice: "Stock #{@user_stock.stock.name} was successfully added" }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: "#{@user_stock.stock.ticker} #{@user_stock.stock.name} has been successfully removed from your portfolio." }
